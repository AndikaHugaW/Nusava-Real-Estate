...
export const metadata: Metadata = {
  title: 'About Us - Nusava Real Estate',
  description: 'Learn more about Nusava, Indonesia\'s trusted real estate platform.',
};
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6 lg:px-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-4 max-w-6xl leading-[1.15]">
            ...
            <span className="text-slate-400">Building Indonesia&apos;s most trusted property ecosystem.</span>
          </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mt-16">
            ...
            <div className="relative aspect-[4/3] rounded-[3rem] overflow-hidden border border-slate-100">
              <img
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-screen-2xl mx-auto px-6 lg:px-16">
          <div className="text-center mb-16">
            <div className="inline-block bg-white px-6 py-2 rounded-full mb-6 border border-slate-100 shadow-sm">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {values.map((value, i) => (
              <div 
                key={i} 
                className="p-12 bg-white rounded-[3rem] shadow-sm border border-slate-100 flex flex-col items-start"
              >
        ...
        <div className="max-w-screen-2xl mx-auto px-6 lg:px-16">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, i) => (
              <div key={i} className="text-center">
                <div className="relative aspect-square rounded-[2rem] overflow-hidden mb-6 border border-slate-100">
                  <img
                    src={member.image}
                    alt={member.name}
